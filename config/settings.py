...
SECRET_KEY = 'django-insecure-cna4(3z$zl9jjl*4#(kg#x@+u^3(5fey&2u1@*(p_lub)lg4(_'
...
INSTALLED_APPS = [
    ...
    'training_plan_app.apps.TrainingPlanAppConfig',
    'tinymce',
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'training_plan_app' / 'static',
]
